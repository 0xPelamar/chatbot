...
//   - ctx context.Context
//   - ent T
func (_e *MockCommonBehaviour_Expecter[T]) Save(ctx interface{}, ent interface{}) *MockCommonBehaviour_Save_Call[T] {
...
func (_mock *MockAccountRepository) Save(ctx context.Context, ent entity.Account) error {
	ret := _mock.Called(ctx, ent)
...
//   - ctx context.Context
//   - ent entity.Account
func (_e *MockAccountRepository_Expecter) Save(ctx interface{}, ent interface{}) *MockAccountRepository_Save_Call {
	return &MockAccountRepository_Save_Call{Call: _e.mock.On("Save", ctx, ent)}
}

func (_c *MockAccountRepository_Save_Call) Run(run func(ctx context.Context, ent entity.Account)) *MockAccountRepository_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAccountRepository_Save_Call) RunAndReturn(run func(ctx context.Context, ent entity.Account) error) *MockAccountRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
